                    ...
                    <div class="card-body px-4 py-4-5">
                        <div class="row">
                            ...
                            <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                <h6 class="text-muted font-semibold">Member Aktif</h6>
                                <h6 class="font-extrabold mb-0">{{$member_aktif}}</h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card shadow-lg">
                    <div class="card-body px-4 py-4-5">
                        <div class="row">
                            ...
                            <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                <h6 class="text-muted font-semibold">Member Nonaktif</h6>
                                <h6 class="font-extrabold mb-0">{{$member_non}}</h6>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body px-4 py-4-5">
                        <div class="row">
                            ...
                            <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                ...
                                <h6 class="font-extrabold mb-0">{{$modul}}</h6>
                            </div>
                        </div>
                    </div>
                </div>
